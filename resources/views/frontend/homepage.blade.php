...
@section('content')
    <div class="hero" style="background-image: url('{{ asset('frontend/images/ras.png') }}')">
        <div class="container">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="step">
                        ...
                        <div class="step-inner">
                            ...
                            <h3>Pembayaran</h3>
                            <p>
                                Lakukan Pembayaran sesuai dengan harga yang tertera dan bayarlah tepat waktu!
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 text-center order-lg-2">
                    <div class="img-wrap-1 mb-5">
                        <img src="{{ asset('images/poto.webp') }}" alt="Image" class="img-fluid" />
                    </div>
                </div>
                <div class="col-lg-4 ml-auto order-lg-1">
                    ...
                    <p class="mb-5">
                        RAS Rental Mobil memberikan pelayanan terbaik untuk anda yang
                        mau menyewa mobil. Jadi, jika anda ingin menyewa mobil dengan
                        kualitas dan pelayanan terbaik RAS Rental Mobil bisa anda hubungi!
                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <p class="mb-5">
                        Inilah Daftar Mobil Yang Tersedia Di RAS Rental Mobil.
                    </p>
                </div>
            </div>
